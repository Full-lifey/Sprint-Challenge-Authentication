...
- The purpose of using sessions is to allow user logins to persist. This way the user does not have to login every time they go to a new page.
...
- It allows us to has passwords many many times. That process takes time which makes brute-force attacking those passwords much more difficult.
